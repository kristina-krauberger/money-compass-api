...
def ai_coach_welcome():
    ...
    title = f"Hey {name}! Mega, dass du startest! Bereit für deinen ersten echten Schritt? 🚀" if name else "Hey! Mega, dass du startest! Bereit für deinen ersten echten Schritt? 🚀"
    return {
        "name": "Clara",
